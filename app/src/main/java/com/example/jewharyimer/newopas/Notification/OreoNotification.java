...
public class OreoNotification extends ContextWrapper {
    private static final String CHANNEL_ID="com.example.jewharyimer.newopas";
    private static final String CHANNEL_NAME="newopas";
    ...
    @TargetApi(Build.VERSION_CODES.O)
    public Notification.Builder getOrioNotification(String title, String body,
