...
import com.example.jewharyimer.newopas.reminders.AlarmScheduler;
...
public class TaskDetailActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        android.support.v7.widget.Toolbar toolbar =  findViewById(R.id.add_sc_toolbar);
        setSupportActionBar(toolbar);


        mTaskDescription =  findViewById(R.id.text_description);
    ...
    private void deleteTask() {
        ...
        //deletion of firebase schedule will be set
 ...
 //pudatting firebase will be performed
    }
